...
MODEL_PROFILES: dict[str, InkbirdIntModelProfile] = {
    ...
    MODEL_INT14S_BW: InkbirdIntModelProfile(
        ...
        support_status="community_validated",
    ...
    MODEL_INT12E_BW: InkbirdIntModelProfile(
        ...
        write_support="not_supported",
        support_status="community_validated",
        notes="Community-validated read-only BLE: notification updates plus fallback direct GATT polling for two 13-byte FF01 probe blocks, station temperature and three-byte 2A19 battery data. Writes, LAN and cloud remain disabled.",
