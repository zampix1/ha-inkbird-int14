...
BASE_DIAGNOSTIC_DESCRIPTIONS = [
    ...
    DiagnosticDescription("ble_debug_status", "BLE Diagnostic Status", enabled_default=True),
    DiagnosticDescription("ble_debug_match_source", "BLE Diagnostic Match Source"),
    DiagnosticDescription(
        "ble_debug_scanner_match_count",
        "BLE Diagnostic Scanner Match Count",
        state_class=SensorStateClass.MEASUREMENT,
        enabled_default=True,
    ),
    DiagnosticDescription(
        "ble_debug_last_run_epoch_s",
        "BLE Diagnostic Last Run Epoch",
        native_unit="s",
        state_class=SensorStateClass.MEASUREMENT,
        enabled_default=True,
    ),
    DiagnosticDescription("ble_debug_service_count", "BLE Diagnostic Service Count", state_class=SensorStateClass.MEASUREMENT),
    DiagnosticDescription(
        "ble_debug_characteristic_count",
        "BLE Diagnostic Characteristic Count",
        state_class=SensorStateClass.MEASUREMENT,
    ),
    DiagnosticDescription(
        "ble_debug_read_value_count",
        "BLE Diagnostic Read Value Count",
        state_class=SensorStateClass.MEASUREMENT,
    ),
    DiagnosticDescription(
        "ble_debug_notification_count",
        "BLE Diagnostic Notification Count",
        state_class=SensorStateClass.MEASUREMENT,
    ),
    DiagnosticDescription("ble_debug_last_error_type", "BLE Diagnostic Last Error Type"),
    DiagnosticDescription("ble_debug_last_error", "BLE Diagnostic Last Error", enabled_default=True),
